...
conn.sendPresenceUpdate("composing", m.chat)
  ...
  let arrayMenu = ['anonymous', 'main', 'ai', 'jadibot',  'textprome', 'sound', 'store', 'ephoto', 'downloader', 'kerang', 'premium', 'game', 'group', 'internet', 'maker', 'owner', 'cerpen', 'sticker', 'tools', 'anime', 'fun','quotes','islamic']
